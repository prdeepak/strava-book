...
// Default selection for future use
const _defaultSelection = availableVariants.find(v => v.templateId === 'race_section') || availableVariants[0]
void _defaultSelection // Silence unused variable warning
