...
export default function PdfImageSizingPage() {
  ...
  useEffect(() => {
    ...
    debounceRef.current = setTimeout(async () => {
      ...
      try {
        ...
        const response = await fetch(`/api/test/pdf-image-sizing?${params}`)
        if (response.ok) {
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white p-6">
      <h1 className="text-2xl font-bold mb-6">PdfImage Sizing Test</h1>
